...
class __TwigTemplate_c3d3091d7897bf563fe4335a4ec6c457adbaf696a0c13804848c92703ca998f3 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t";
        // line 24
        echo twig_call_macro($macros["forms"], "macro_input", [["id" => ("firstname" . ($context["modalType"] ?? null)), "name" => "firstname", "value" => "", "placeholder" => ($context["firstnameLabel"] ?? null), "type" => "text", "autocomplete" => false, "required" => true]], 24, $context, $this->getSourceContext());
        echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t</div>
...
\t\t\t\t\t\t\t";
        // line 31
        echo twig_call_macro($macros["forms"], "macro_input", [["id" => ("lastname" . ($context["modalType"] ?? null)), "name" => "lastname", "value" => "", "placeholder" => ($context["lastnameLabel"] ?? null), "type" => "text", "autocomplete" => false, "required" => true]], 31, $context, $this->getSourceContext());
        echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t</div>
...
\t\t\t\t\t\t";
        // line 37
        echo twig_call_macro($macros["forms"], "macro_input", [["id" => ("email" . ($context["modalType"] ?? null)), "name" => "email", "value" => "", "placeholder" => ($context["emailLabel"] ?? null), "type" => "text", "autocomplete" => false, "required" => true]], 37, $context, $this->getSourceContext());
        echo "
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t\t<div class=\"col-lg-3 col-md-6 col-item\">
...
\t\t\t\t\t\t";
        // line 47
        echo twig_call_macro($macros["forms"], "macro_textarea", [["id" => ("message" . ($context["modalType"] ?? null)), "name" => "message", "value" => "", "placeholder" => ($context["messageLabel"] ?? null), "type" => "text"]], 47, $context, $this->getSourceContext());
        echo "
\t\t\t\t\t</div>
\t\t\t\t</div>
        <div class=\"col-md-12 col-item\">
...
\t\t\t\t";
        ...
        if ((($context["modalType"] ?? null) == "contact")) {
            // line 62
            echo "        <a type=\"button\" class=\"btn btn-outline-info\" href=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["global"] ?? null), "theme_options", [], "any", false, false, false, 62), "website", [], "any", false, false, false, 62), "pdf_file_download", [], "any", false, false, false, 62), "url", [], "any", false, false, false, 62), "html", null, true);
...
";
    ...
    {
        return array (  152 => 64,  144 => 62,  142 => 61,  138 => 60,  131 => 56,  124 => 52,  116 => 47,  108 => 42,  100 => 37,  91 => 31,  81 => 24,  75 => 21,  69 => 17,  65 => 15,  63 => 14,  61 => 13,  59 => 12,  57 => 11,  55 => 10,  53 => 9,  51 => 8,  49 => 7,  47 => 6,  45 => 5,  43 => 4,  41 => 3,  39 => 2,  37 => 1,);
    }
