...
class Lec_Product_Type_Plugin {
    ...
    public function __construct() {
        ...
        add_action( 'woocommerce_admin_order_data_after_billing_address', array($this, 'lec2_checkout_field_display_admin'), 20, 1 );
    ...
    public function add_type( $types ) {
        $types['training'] = __( 'Training', 'lec2_text_domain' );
