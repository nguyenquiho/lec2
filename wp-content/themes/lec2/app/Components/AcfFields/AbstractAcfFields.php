...
/**
 * Class AbstractAcfFields
 * @package App\Components\AcfFields
 */
abstract class AbstractAcfFields
{
    /**
     * vars
     */
    ...
    function __construct() {
        ...
        $this->add_field_filter('acf/prepare_field',				array($this, 'prepare_field'), 100, 1);
    ...
    */
    ...
    /**
     * Render this field into edit-page on admin panel
     *
     * @param $data
