...
array_unshift($data['custom_data']['cats'], array("label" => "All", "value" => ""));
$data['custom_data']['trainings'] = $trainings->execute();
$data['custom_data']['training_types'] = $trainingTypeOptions;
array_unshift($data['custom_data']['training_types'], array("label" => "All", "value" => ""));
...
$data['custom_data']['banner']['title'] = sprintf( __( '%s Trainings', 'lec2_text_domain' ), $page_cat['name'] );
